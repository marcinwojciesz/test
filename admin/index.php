        ...
        <aside class="admin-sidebar">
            ...
            <nav class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <ul class="nav-links">
                        <li><a href="<?php echo admin_url(); ?>" class="nav-link active"><span>🏠</span><span>Dashboard</span></a></li>
                    </ul>
                </div>
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-links">
                        <li><a href="<?php echo admin_url('users.php'); ?>" class="nav-link"><span>👥</span><span>Użytkownicy</span></a></li>
                        <li><a href="<?php echo admin_url('pages.php'); ?>" class="nav-link"><span>📄</span><span>Strony</span></a></li>
                        <li><a href="<?php echo admin_url('menu.php'); ?>" class="nav-link"><span>🔗</span><span>Menu</span></a></li>
                    </ul>
                </div>
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-links">
                        <li><a href="<?php echo admin_url('settings.php'); ?>" class="nav-link"><span>⚙️</span><span>Ustawienia</span></a></li>
                    </ul>
                </div>
            </nav>
        </aside>
