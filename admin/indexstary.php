<?php
/**
 * Panel Administratora - NOWOCZESNY DASHBOARD
 * Z WBUROWANYM CSS - TAK JAK DZIAŁAŁO
 */
...
<head>
    ...
    <style>
        /* NOWOCZESNY PANEL ADMINISTRATORA - WBUROWANY CSS */
        :root {
            --primary: #6366f1;
            --primary-dark: #4f46e5;
            --accent: #06b6d4;
    ...
    <div class="admin-container">
        ...
        <aside class="admin-sidebar">
            <div class="sidebar-header">
                <a href="/cms_portal/admin/" class="sidebar-logo">
                    <div class="logo-icon">
            ...
            <nav class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <ul class="nav-links">
                        <li>
                            <a href="/cms_portal/admin/" class="nav-link active">
                                <span>📊</span>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a href="/cms_portal/admin/statistics.php" class="nav-link">
                                <span>📈</span>
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-links">
                        <li>
                            <a href="/cms_portal/admin/users.php" class="nav-link">
                                <span>👥</span>
                                <span>Użytkownicy</span>
                            </a>
                        </li>
                        <li>
                            <a href="/cms_portal/admin/pages.php" class="nav-link">
                                <span>📄</span>
                                <span>Strony</span>
                            </a>
                        </li>
                        <li>
                            <a href="/cms_portal/admin/menu.php" class="nav-link">
                                <span>🧩</span>
                                <span>Menu</span>
                            </a>
                        </li>
        ...
        <main class="admin-main">
            ...
            <header class="admin-header">
                ...
                <div class="user-menu">
                    ...
                    <a href="/cms_portal/" class="btn btn-outline">
            ...
            <div class="admin-content">
                ...
                <div class="features-grid">
                    <div class="feature-card">
                        ...
                        <a href="/cms_portal/admin/users.php" class="btn btn-primary">
                    ...
                    <div class="feature-card">
                        ...
                        <a href="/cms_portal/admin/pages.php" class="btn btn-primary">
                            <i class="fas fa-arrow-right"></i>
                            Przejdź
                        </a>
                    </div>
                    ...
                    <div class="feature-card">
                        ...
                        <a href="/cms_portal/admin/menu.php" class="btn btn-primary">
                            <i class="fas fa-arrow-right"></i>
                            Przejdź
                        </a>
                    </div>
                ...
                <div class="system-info">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            <span>Wersja CMS:</span>
                            <span>1.0 Development</span>
                        </div>
                        <div class="info-item">
                            <span>PHP:</span>
